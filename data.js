...
window.ODYSSEUS_DATA = (() => {
  ...
  const precisionPrompts={
    t1:"Nenne den einen Grund, weshalb die Götter zu Beginn der Heimreise auf die Achaier zornig sind.",
    t2:"Schreibe genau drei Zuordnungen: Menelaos - zugehörige Person; Agamemnon - Verwandtschaft mit Menelaos; Odysseus - Heimatinsel.",
    t3:"Erkläre die Ereigniskette bei den Kikonen in genau drei Schritten: 1. Odysseus’ Rat, 2. Verhalten der Gefährten, 3. Verlust auf jedem Schiff.",
    lo1:"Nenne genau die zwei Erinnerungen oder Wünsche, welche die Lotosfrucht bei den Männern auslöscht.",
    lo2:"Schreibe je einen kurzen Gedanken desselben Gefährten: zuerst vor dem Essen mit seinem Reiseziel, danach mit seinem neuen Wunsch.",
    lo3:"Ordne alle vier eingeblendeten Ereignisse chronologisch: vom gebrochenen Kundschafterauftrag bis zur abgeschlossenen Rettung am Schiff.",
    p2:"Nenne genau zwei Handlungen: Wie machen die Männer Polyphem kampfunfähig, und wie gelangen sie unbemerkt aus der Höhle?",
    p3:"Nenne die eine Handlung nach der gelungenen Flucht, durch die Polyphem Odysseus eindeutig identifizieren kann.",
    pf1:"Erkläre die Rachekette in drei Schritten: 1. Odysseus’ stolze Handlung, 2. Polyphems Bitte, 3. Poseidons Grund für die Verfolgung.",
    pf2:"Formuliere aus Sicht eines geretteten Gefährten genau einen Vorwurf gegen Odysseus’ Namensruf und nenne die dadurch entstandene Gefahr.",
    pf3:"Nenne Polyphems Verwandtschaft mit Poseidon und erkläre, wie sein Gebet die späteren Stürme zu gezielter Rache macht.",
    w1:"Nenne die eine falsche Vermutung, aufgrund deren die Gefährten den Windsack öffnen.",
    w2:"Ordne alle vier eingeblendeten Ereignisse chronologisch: vom Verlust der Kontrolle über den Windsack bis zur Umkehr der Schiffe.",
    w3:"Vergleiche den Umfang der Verluste: Was verliert Odysseus bei Polyphem, und was verliert er bei den Laistrygonen?",
    la1:"Verbinde genau zwei Ortsmerkmale mit dem Angriff: Wie hindert die enge Bucht die Schiffe an der Flucht, und von wo greifen die Laistrygonen an?",
    la2:"Nenne Odysseus’ abweichenden Ankerplatz und die eine Handlung, mit der sein Schiff entkommt.",
    la3:"Nenne genau zwei Folgen des Angriffs: 1. den Verlust an Schiffen und Gefährten, 2. die neue Grösse der weiterreisenden Flotte.",
    k1:"Schreibe genau drei Zuordnungen: Kirke - Mittel der Verwandlung; Hermes - Schutzmittel; Teiresias - Wissen für die Heimkehr.",
    k2:"Nenne die Person, die Odysseus in der Unterwelt befragen muss, und den Gegenstand dieser Befragung.",
    k3:"Nenne genau zwei Warnungen des Teiresias: eine zu Helios’ Herde und eine zu Poseidons Widerstand.",
    u1:"Ordne alle vier eingeblendeten Schritte des Totenrituals chronologisch: von Odysseus’ Ankunft am Ritualort bis zur Auskunft des Teiresias.",
    u2:"Nenne alle vier Familiennachrichten von Antikleia: Penelopes Verhalten, Telemachos’ Lage, Laertes’ Zustand und Antikleias Todesursache.",
    u3:"Nenne Teiresias’ konkrete Warnung vor Helios’ Herde und erkläre Odysseus’ daraus entstehende Führungsaufgabe gegenüber der Mannschaft.",
    m1:"Schreibe genau drei Zuordnungen: Wachs in den Ohren - Gefahr; Fesselung am Mast - Zweck; Fahrt nahe Skylla - vermiedene Gefahr.",
    m2:"Nenne die eine befürchtete Reaktion der Gefährten, wegen der Odysseus ihnen Skylla verschweigt.",
    m3:"Nenne genau zwei Tatsachen: 1. Was darf Odysseus bei den Sirenen als Einziger tun? 2. Wie viele Männer reisst Skylla fort?",
    sk1:"Vergleiche die beiden unvermeidbaren Schäden: Was droht dem ganzen Schiff bei Charybdis, und welcher sichere Verlust droht bei Skylla?",
    sk2:"Schreibe genau zwei begründete Sätze: einen Vorwurf des Gefährten wegen des verschwiegenen Wissens und Odysseus’ Verteidigung mit der verhinderten Reaktion.",
    sk3:"Nenne Kirkes Aussage über Skyllas Unverwundbarkeit und die zusätzliche Gefahr eines Kampfversuchs.",
    h1:"Ordne alle vier eingeblendeten Ereignisse chronologisch: von der erzwungenen Wartezeit auf Thrinakia bis zum Untergang des letzten Schiffs.",
    h3:"Nenne trotz Kalypso genau zwei Gründe für Odysseus’ Heimkehrwunsch: eine Person und einen Ort.",
    ka1:"Nenne genau zwei Gründe, weshalb Kalypso für Odysseus kein glückliches Ziel ist: seinen Heimkehrwunsch und seine fehlende Freiheit.",
    ka2:"Ordne jeder Gottheit genau eine Rolle zu: Wer fordert Hilfe, wer entscheidet, wer überbringt den Befehl, und wer gehorcht widerwillig?",
    ka3:"Schreibe zwei getrennte Sätze für Odysseus’ Logbuch: einen mit seinem Ziel Ithaka und einen mit der Gefahr durch Meer oder Poseidon.",
    i1:"Nenne genau drei Bedrohungen im Palast: eine für den Besitz, eine für Penelope und eine für Telemachos als Erben.",
    i2:"Nenne den Namen der Gestalt, als die Athene Telemachos zuerst erscheint, und ihre Beziehung zu Odysseus’ Haus.",
    i3:"Ordne alle vier eingeblendeten Schritte von Telemachos chronologisch: von Athenes erstem Anstoss bis zu seinem Entschluss zur Nachrichtensuche.",
    pe1:"Erkläre Penelopes Weblist in drei Schritten: ihr Versprechen an die Freier, ihre Arbeit am Tag und ihre Handlung in der Nacht.",
    pe2:"Nenne den familiären Zweck des Tuchs für Laertes und erkläre, wie seine hinausgezögerte Fertigstellung Penelopes Heirat verzögert.",
    pe3:"Schreibe Penelopes Nachricht in genau zwei Teilen: Welchen Nutzen hat die Weblist, und wodurch endet ihre Wirksamkeit?",
    s1:"Schreibe genau drei Zuordnungen: Nestor - Nachricht; Menelaos - Nachricht des Proteus; Helena - Beobachtung an Telemachos.",
    s2:"Nenne genau zwei Nachrichten, die Telemachos über Odysseus erhält: seinen Lebenszustand und seinen Aufenthaltsgrund.",
    s3:"Nenne Ort und Ziel des Plans, den die Freier für Telemachos’ Rückfahrt vorbereiten.",
    hi1:"Nenne Telemachos’ zwei Veränderungen nach der Reise und erkläre, weshalb er dadurch die Machtpläne der Freier als Erbe bedroht.",
    hi2:"Ordne alle vier eingeblendeten Ereignisse chronologisch: von der Entstehung des Mordplans bis zu Telemachos’ sicherer Rückkehr nach Ithaka.",
    hi3:"Schreibe Telemachos’ Bericht in zwei Teilen: 1. Nachricht über Odysseus, 2. neue Verantwortung für Haus und gemeinsamen Plan.",
    f1:"Schreibe genau vier Zuordnungen: Hermes, Poseidon, Leukothea und Athene - jeweils mit ihrer konkreten Wirkung auf Odysseus’ Weiterreise.",
    f2:"Nenne die eine gesellschaftliche Folge, die Nausikaa vermeiden will, indem sie Odysseus nicht durch die Stadt begleitet.",
    f3:"Beantworte beide Teile: 1. Welches frühere Geschehen erzählt Odysseus bei den Phaiaken? 2. Warum ist diese Erzählung ein Rückblick?",
    na1:"Nenne Athenes zwei Eingriffe, die Nausikaa zum Fluss führen und Odysseus dort aufwecken.",
    na2:"Nenne genau drei Merkmale von Odysseus’ Bitte: Abstand, Wortwahl und Verzicht auf eine körperliche Bittgeste.",
    na3:"Nenne die eine Gefahr für Nausikaas Ruf, wenn Odysseus ihr sichtbar durch die Stadt folgen würde.",
    e1:"Nenne genau zwei Zwecke der Bettlerverkleidung: Was kann Odysseus unerkannt untersuchen, und wen kann er prüfen?",
    e2:"Nenne die vier Beteiligten, die in Kapitel 7 zur sicheren Wiederbegegnung und zum gemeinsamen Plan beitragen.",
    e3:"Ordne alle vier eingeblendeten Ereignisse chronologisch: von Telemachos’ Rückkehr nach Ithaka bis zum gemeinsamen Plan von Vater und Sohn.",
    eu1:"Nenne genau drei Belege für Eumaios’ Treue: seine Worte über Odysseus, seinen Umgang mit dessen Besitz und sein Verhalten gegenüber dem Bettler.",
    eu2:"Nenne genau drei Zwecke der erfundenen Lebensgeschichte: Tarnung, Prüfung des Eumaios und angedeutete Heimkehrhoffnung.",
    eu3:"Ordne Eumaios genau drei Eigenschaften mit je einem Szenenbeleg zu: gastfreundlich, loyal und vorsichtig.",
    b1:"Nenne die eine Figur, die den verkleideten Odysseus sofort erkennt.",
    b2:"Schreibe genau drei Zuordnungen: Eumaios, Antinoos und Melanthios - jeweils mit ihrem Verhalten gegenüber dem Bettler.",
    b3:"Nenne genau zwei strategische Vorteile der unbekannten Identität: gewonnenes Wissen und Vorteil für den späteren Angriff.",
    ar1:"Beantworte zwei Punkte: 1. Wer erkennt Odysseus trotz Bettlergestalt? 2. Welchen Plan würde eine offene Gefühlsreaktion gefährden?",
    ar2:"Vergleiche Argos und Odysseus’ Haus: Nenne je den früheren Zustand, den gegenwärtigen Verfall und die fortbestehende Treue.",
    ar3:"Schreibe aus Argos’ Sicht genau zwei Wahrnehmungen des Heimkehrers und Argos’ letzte Reaktion; der Name Odysseus darf nicht vorkommen.",
    n1:"Nenne das Körpermerkmal und die Körperstelle, an denen Eurykleia Odysseus erkennt.",
    n2:"Nenne den konkreten Plan, den Eurykleias Schweigen vor einer zu frühen Enthüllung schützt.",
    n3:"Nenne die zwei gleichzeitig laufenden Vorbereitungen im Palast: Penelopes genaue Befragung des Fremden und das Entfernen der Waffen aus dem Saal.",
    fr1:"Nenne genau drei Gründe für Odysseus’ Schweigen gegenüber Penelope: Geheimhaltung des Plans, weitere Prüfung der Lage und Überraschungsvorteil.",
    fr2:"Nenne die zwei Arten überprüfbarer Einzelheiten, nach denen Penelope den Fremden zu Odysseus befragt.",
    fr3:"Nenne genau drei Merkmale der erfundenen Biografie: strategischer Zweck, wahre Einzelheiten und Schutz beziehungsweise Prüfung.",
    g1:"Ordne alle vier eingeblendeten Ereignisse chronologisch: vom Versuch der Freier mit dem Bogen bis zu Odysseus’ offener Enthüllung.",
    g2:"Nenne genau die drei Menschen, die im Palast an Odysseus’ Seite kämpfen.",
    g3:"Nenne die Gruppe, die Odysseus verantwortlich macht, und den konkreten Missbrauch, für den er keine Verhandlung mehr zulässt.",
    vh1:"Ordne alle vier eingeblendeten Vorbereitungen chronologisch: vom geheimen Plan von Vater und Sohn bis zur unmittelbaren Sicherung des Kampfraums.",
    vh2:"Vergleiche drei Personen: Nenne je einen Treuebeleg für Eumaios und Philoitios sowie zwei Verratshandlungen des Melanthios.",
    vh3:"Nenne für jeden der vier Kämpfer genau eine Hauptaufgabe: Odysseus, Telemachos, Eumaios und Philoitios.",
    l1:"Nenne die Baumart, aus deren lebendem Stamm Odysseus den festen Kern des Ehebetts gebaut hat.",
    l2:"Schreibe genau drei Zuordnungen: Eurykleia, Penelope und Laertes - jeweils mit ihrem Beweis für Odysseus’ Identität.",
    l3:"Nenne die Gottheit, die eingreift, und das Ergebnis ihres Eingriffs im Kampf mit den Angehörigen der Freier.",
    ob1:"Beantworte zwei Punkte: 1. Weshalb prüft oder schont Odysseus Laertes zunächst? 2. Welche drei Beweisarten überzeugen den Vater?",
    ob2:"Schreibe genau drei Zuordnungen: Bäume - Vater und Heimat; Bogen - Herrschaft und Fähigkeit; Bett - Ehe und gemeinsame Erinnerung.",
    ob3:"Erkläre die noch offene Gefahr nach dem Tod der Freier und nenne die zwei Folgen, die Athenes Friedensschluss verhindert beziehungsweise wiederherstellt."
  };
  const precisionAnswers={
    w3:"Bei Polyphem verliert Odysseus einzelne Gefährten; bei den Laistrygonen werden fast die ganze Flotte und ein grosser Teil der Mannschaft auf einmal vernichtet.",
    i1:["Die Freier verbrauchen Odysseus’ Besitz.","Sie bedrängen Penelope zur Heirat.","Sie gefährden Telemachos’ Stellung und Leben als Erbe."],
    i2:"Athene erscheint als Mentes, ein alter Gastfreund von Odysseus’ Haus.",
    s2:"Odysseus lebt, wird aber von Kalypso auf ihrer Insel festgehalten.",
    s3:"Die Freier planen auf dem Seeweg nach Ithaka einen Hinterhalt, um Telemachos bei seiner Rückkehr zu töten.",
    f3:"Bei den Phaiaken erzählt Odysseus seine früheren Abenteuer der Irrfahrt. Diese Ereignisse geschahen vor seiner Ankunft bei den Phaiaken und werden deshalb rückblickend erzählt.",
    n3:["Penelope befragt den Fremden genau.","Odysseus und Telemachos lassen die Waffen aus dem Saal entfernen."],
    g3:"Odysseus macht alle Freier gemeinsam für den Verbrauch seines Besitzes, die Bedrängung Penelopes und den Missbrauch seines Hauses verantwortlich.",
    ob3:"Die Angehörigen der Freier wollen Rache. Athene verhindert eine neue Vergeltungsrunde und stellt dauerhaften Frieden und Ordnung auf Ithaka her."
  };
  stations.forEach((station,stationIndex)=>{
    Object.assign(station,stationContexts[station.id]);
    station.tasks.forEach((q,taskNumber)=>{
      const originalType=q.type;
      q.prompt=precisionPrompts[q.id]||simplePrompts[q.id]||q.prompt;q.promptSimplified=Boolean(precisionPrompts[q.id]||simplePrompts[q.id]);
      if(Object.hasOwn(precisionAnswers,q.id))q.answer=precisionAnswers[q.id];
