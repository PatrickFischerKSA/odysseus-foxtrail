(() => {
  ...
  function showMedia(){
    ...
    view.innerHTML=head(m.title,"ERGÄNZENDE MULTIMEDIA-SPUR")+`<div class="media-layout">
      <section class="panel media-player"><video controls preload="metadata">
        <source src="${m.video}" type="video/mp4">Dein Browser kann dieses Video nicht wiedergeben.
      </video><div class="media-meta"><span class="chip">${esc(m.sourceType)}</span>
